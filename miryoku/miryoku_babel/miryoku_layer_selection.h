...
#include "miryoku_layer_alternatives.h"
      ...
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_GRAPHITE_FLIP
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_GRAPHITE)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_GRAPHITE_FLIP
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_TAP_GRAPHITE)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_GRAPHITE_FLIP
    ...
    #elif defined (MIRYOKU_TAP_GRAPHITE)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_GRAPHITE
    #elif defined (MIRYOKU_TAP_HALMAK)
